...
import { fetchModelDrivenApps, fetchAccessToken } from '../../services/dataverseService';
import type { ModelDrivenApp, Theme } from '../../types';
import { ModelDrivenAppTable } from '../tables/ModelDrivenAppTable';
import { ModelDrivenAppDetailModal } from '../details/ModelDrivenAppDetailModal';
import { LoadingIcon, SearchIcon, FilterIcon, ArrowUpIcon, ArrowDownIcon } from '../IconComponents';
import { BASE_DATAVERSE_URL_MODEL_DRIVEN_APPS, MODEL_DRIVEN_APP_FIELDS } from '../../constants';
...
export const ModelDrivenAppsView: React.FC<{ notification: string | null; setNotification: (message: string | null) => void; theme: Theme }> = ({ notification, setNotification, theme }) => {
